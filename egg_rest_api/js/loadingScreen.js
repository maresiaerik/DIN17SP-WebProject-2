  ...
  let goldEgg = base_url + '/images/Gold_Egg.png';
  let silverEgg = base_url + '/images/Silver_Egg.png';
  let bronzeEgg = base_url + '/images/Bronze_Egg.png';
  let eggIndex = 0;
  let eggArr = [ bronzeEgg, silverEgg, goldEgg ];
  let isCanvasVisible = false;

  let eggLoadingAnimation;
...
$(document).ready( () =>
{
  ...
  eggLoadingAnimation = setInterval( () =>
  {
